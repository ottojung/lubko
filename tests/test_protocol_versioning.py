...
# ---------------------------------------------------------------------------
# Application parser version validation.
# ---------------------------------------------------------------------------
...
def test_parser_rejects_missing_and_null_version() -> None:
    ...
    PostgreSQL deliberately treats payload as opaque text, so the runtime parser
    is the authority that rejects missing or malformed application versions.
    """
