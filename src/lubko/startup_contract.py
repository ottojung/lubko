...
class StartupContract:
    ...
    def from_dict(cls, data: dict[str, object]) -> StartupContract:
        ...
        required_environment = _require_str_tuple(
            data.get("required_environment"), "required_environment"
        )
        return cls(
...
CURRENT_CONTRACT: Final = StartupContract(
    ...
    required_environment=(SUPERVISOR_STATE_TOKEN_ENV,),
)
...
def generate_startup_launcher_content() -> str:
    ...
    return (
        ...
        f"# Requires externally supplied {SUPERVISOR_STATE_TOKEN_ENV}; do not generate it here.\n"
        f"exec {command}\n"
    )
